...
const Header = () => {
  ...
  return (
    <motion.header 
      ...
      variants={{
        top: { backgroundColor: 'rgba(255, 255, 255, 1)', backdropFilter: 'blur(0px)', boxShadow: '0 0 0 rgba(0,0,0,0)' },
        scrolled: { backgroundColor: 'rgba(255, 255, 255, 0.95)', backdropFilter: 'blur(8px)', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1)' }
      }}
